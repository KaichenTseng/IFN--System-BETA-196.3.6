...
print('''
   ...
   IFNS-ES (加密/解密系統) 版本16.3.6(Beta) is Starting...
   ----------------------------------------------------
...
print(Fore.RED + '''
   ...
   (You're currently using a beta version, some programs might not work as expected.)''') ; sleep(3)
...
plain_text = input (Fore.RED + '''      1E- Enter message to be ENCRYPTED : ''')
print(''' 
    ''')
...
#Decryption Sevice
enter_encrypted_text = input(Fore.RED + '''
